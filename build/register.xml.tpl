...
<package name="terminal" version="{{PLUGIN_VERSION}}">
    ...
    <systemParameters>
        ...
        <systemParameter name="TERMINAL_FIELD_POD_IP" scopeType="plugins" defaultValue="ip_address" />
        ...
        <systemParameter name="TERMINAL_LOG_LEVEL" scopeType="plugins" defaultValue="info" />
        <systemParameter name="TERMINAL_EXPR_POD_TO_CLUSTER" scopeType="plugins" defaultValue="wecmdb:pod.app_instance>wecmdb:app_instance.k8s_cluster>wecmdb:k8s_cluster" />
        <systemParameter name="TERMINAL_CLUSTER_FIELD_API" scopeType="plugins" defaultValue="api_server_address" />
        <systemParameter name="TERMINAL_CLUSTER_FIELD_TOKEN" scopeType="plugins" defaultValue="api_token" />
        <systemParameter name="TERMINAL_CLUSTER_FIELD_NAMESPACE" scopeType="plugins" defaultValue="cluster_default_namespace" />
        <systemParameter name="TERMINAL_EXPR_POD_TO_NAMESPACE" scopeType="plugins" defaultValue="" />
        <systemParameter name="TERMINAL_NAMESPACE_FIELD_NAME" scopeType="plugins" defaultValue="code" />
        <systemParameter name="TERMINAL_NAMESPACE_FIELD_CLUSTER" scopeType="plugins" defaultValue="k8s_cluster" />
    </systemParameters>
    ...
    <resourceDependencies>
        <docker imageName="{{IMAGENAME}}" containerName="{{CONTAINERNAME}}" portBindings="{{ALLOCATE_PORT}}:9001,9002:9002,19002:9002" volumeBindings="/etc/localtime:/etc/localtime,{{BASE_MOUNT_PATH}}/terminal/logs:/var/log/terminal,{{BASE_MOUNT_PATH}}/certs:/certs,{{BASE_MOUNT_PATH}}/terminal/records:/data/terminal/records" envVariables="TERMINAL_DB_USERNAME={{DB_USER}},TERMINAL_DB_PASSWORD={{DB_PWD}},TERMINAL_DB_HOSTIP={{DB_HOST}},TERMINAL_DB_HOSTPORT={{DB_PORT}},TERMINAL_DB_SCHEMA={{DB_SCHEMA}},TERMINAL_ASSET_TYPE={{TERMINAL_ASSET_TYPE}},TERMINAL_FIELD_NAME={{TERMINAL_FIELD_NAME}},TERMINAL_FIELD_IP={{TERMINAL_FIELD_IP}},TERMINAL_FIELD_POD_IP={{TERMINAL_FIELD_POD_IP}},TERMINAL_FIELD_PORT={{TERMINAL_FIELD_PORT}},TERMINAL_FIELD_USER={{TERMINAL_FIELD_USER}},TERMINAL_FIELD_PASSWORD={{TERMINAL_FIELD_PASSWORD}},TERMINAL_FIELD_DESC={{TERMINAL_FIELD_DESC}},GATEWAY_URL={{GATEWAY_URL}},JWT_SIGNING_KEY={{JWT_SIGNING_KEY}},TERMINAL_BOXES={{TERMINAL_BOXES}},TERMINAL_SESSION_TIMEOUT={{TERMINAL_SESSION_TIMEOUT}},TERMINAL_WEBSOCKET_URL={{TERMINAL_WEBSOCKET_URL}},TERMINAL_COMMAND_CHECK={{TERMINAL_COMMAND_CHECK}},TERMINAL_FILE_DOWNLOAD_MAX_BYTES={{TERMINAL_FILE_DOWNLOAD_MAX_BYTES}},SUB_SYSTEM_CODE={{SUB_SYSTEM_CODE}},SUB_SYSTEM_KEY={{SUB_SYSTEM_KEY}},ENCRYPT_SEED={{ENCRYPT_SEED}},S3_SERVER_URL={{S3_SERVER_URL}},S3_ACCESS_KEY={{S3_ACCESS_KEY}},S3_SECRET_KEY={{S3_SECRET_KEY}},S3_BUCKET=terminal,TERMINAL_LOG_LEVEL={{TERMINAL_LOG_LEVEL}},TERMINAL_EXPR_POD_TO_CLUSTER={{TERMINAL_EXPR_POD_TO_CLUSTER}},TERMINAL_CLUSTER_FIELD_API={{TERMINAL_CLUSTER_FIELD_API}},TERMINAL_CLUSTER_FIELD_TOKEN={{TERMINAL_CLUSTER_FIELD_TOKEN}},TERMINAL_CLUSTER_FIELD_NAMESPACE={{TERMINAL_CLUSTER_FIELD_NAMESPACE}},TERMINAL_EXPR_POD_TO_NAMESPACE={{TERMINAL_EXPR_POD_TO_NAMESPACE}},TERMINAL_NAMESPACE_FIELD_NAME={{TERMINAL_NAMESPACE_FIELD_NAME}},TERMINAL_NAMESPACE_FIELD_CLUSTER={{TERMINAL_NAMESPACE_FIELD_CLUSTER}}" />
